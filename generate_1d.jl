...
fig, ax = plt.subplots()
ax.semilogy(LinRange(1, length(forward_diff_data), length(forward_diff_data)), forward_diff_data, label = "ForwardDiff", marker = :o)
ax.semilogy(LinRange(1, length(taylor_diff_data), length(taylor_diff_data)), taylor_diff_data, label = "TaylorDiff", marker = :o)
ax.semilogy(LinRange(1, length(enzyme_data), length(enzyme_data)), enzyme_data, label = "Enzyme", marker = :o)
ax.set_xlabel("Order")
